// pages/campusNews/detail/detail.js
...
Page({
  ...
  async loadPostDetail(id) {
    ...
    try {
      ...
      const postData = await get('/news/detail', { id });
      console.log('加载帖子详情成功:', postData);
      const imageList = postData.imgUrls ? postData.imgUrls.split(',') : [];
